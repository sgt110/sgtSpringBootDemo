...
class JunitTestServiceImplMockTest {
    ...
    @ParameterizedTest
    @MethodSource("testGetByBoProvider")
    @DisplayName("测试成功情况！")
    void testGetByBo(TestBO2 testBO2,TestBO expectedResult) {
        ...
        lenient().when(mockMapper.list()).thenReturn(poList);
        ...
        lenient().when(mockNhsaReportStatisticsMapper.list()).thenReturn(list);
    ...
    private static Stream<Arguments> testGetByBoProvider() {
        final TestBO expectedResult1 = new TestBO(0, 1, new TestBO2(0, 0));
        final TestBO expectedResult2 = new TestBO(1, 1, new TestBO2(1, 0));
        final TestBO expectedResult3 = new TestBO(0, 0, new TestBO2(1, 1));

        return Stream.of(arguments(new TestBO2(0, 0), expectedResult1), arguments(new TestBO2(1, 0), expectedResult2),
            arguments(new TestBO2(1, 1), expectedResult3));
    }
